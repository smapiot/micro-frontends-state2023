  ...
  return (
    <>
      ...
      <div class={styles.document}>
        <div class="container">
          <strong>Current version dated July 17, 2023</strong>
          <p class={styles.paragraph}>
            ...
            the management of the smapiot GmbH. The use of the Internet pages of
            the smapiot GmbH is possible without any indication of personal
          ...
          <p class={styles.paragraph}>
            ...
            applicable to the smapiot GmbH. By means of this data protection
          ...
          <p class={styles.paragraph}>
            As the controller, the smapiot GmbH has implemented numerous
          ...
          <ol class={styles.orderedlist}>
            <li class={styles.enumeration}> Definitions</li>
            <p class={styles.paragraph}>
              The data protection declaration of the smapiot GmbH is based on
            ...
            <p class={styles.paragraph}>
              ...
              Phone: +4981029998476
              <br />
              Email: <a href="mailto:info@smapiot.com">info@smapiot.com</a>
              <br />
              Website:{" "}
              <a href="https://www.smapiot.com" target="_blank">
                www.smapiot.com
              </a>
              <br />
            </p>
            <li class={styles.enumeration}>Cookies</li>
            <p class={styles.paragraph}>
              The Internet pages of the smapiot GmbH use cookies. Cookies are
              text files that are stored in a computer system via an Internet
              browser.
            </p>{" "}
            <p class={styles.paragraph}>
            ...
            <p class={styles.paragraph}>
              This allows visited Internet sites and servers to differentiate
              the individual browser of the data subject from other Internet
              browsers that contain other cookies. A specific Internet browser
              can be recognized and identified using the unique cookie ID.
            </p>{" "}
            <p class={styles.paragraph}>
              Through the use of cookies, the smapiot GmbH can provide the users
            ...
            <p class={styles.paragraph}>
              The website of the smapiot GmbH collects a series of general data
              ...
              server log files. Collected information may be (1) the browser
            ...
            <p class={styles.paragraph}>
              When using these general data and information, the smapiot GmbH
              ...
              smapiot GmbH may analyze anonymously collected data and
              ...
              anonymous data of the server log files will be stored separately
            ...
            <p class={styles.paragraph}>
              The website of the smapiot GmbH contains information that enables
            ...
            <li class={styles.enumeration}>Rights of the data subject</li>
            <p class={styles.paragraph}>
            ...
            <ul class={styles.unorderlist}>
              <li class="b">the purposes of the processing;</li>
              <li class="b">the categories of personal data concerned;</li>
              <li class="b">
            ...
            <p class={styles.paragraph}>
              ...
              smapiot GmbH, he or she may, at any time, contact any employee of
              the controller. An employee of smapiot GmbH shall promptly ensure
            ...
            <p class={styles.paragraph}>
              ...
              far as processing is not required. An employee of the smapiot GmbH
            ...
            <p class={styles.paragraph}>
              ...
              data stored by the smapiot GmbH, he or she may at any time contact
              any employee of the controller. The employee of the smapiot GmbH
            ...
            <p class={styles.paragraph}>
              ...
              as long as the processing is based on consent pursuant to point
              (a) of Article 6(1) of the GDPR or point (a) of Article 9(2) of
              the GDPR, or on a contract pursuant to point (b) of Article 6(1)
              of the GDPR, and the processing is carried out by automated means,
              as long as the processing is not necessary for the performance of
            ...
            <p class={styles.paragraph}>
              ...
              may at any time contact any employee of the smapiot GmbH.
            </p>{" "}
            <p class={styles.paragraph}>
            ...
            <p class={styles.paragraph}>
              The smapiot GmbH shall no longer process the personal data in the
            ...
            <p class={styles.paragraph}>
              If the smapiot GmbH processes personal data for direct marketing
              ...
              the smapiot GmbH to the processing for direct marketing purposes,
              the smapiot GmbH will no longer process the personal data for
              these purposes.
            </p>{" "}
            <p class={styles.paragraph}>
              ...
              personal data concerning him or her by the smapiot GmbH for
            ...
            <p class={styles.paragraph}>
              ...
              contact any employee of the smapiot GmbH. In addition, the data
            ...
            <p class={styles.paragraph}>
              ...
              consent, the smapiot GmbH shall implement suitable measures to
              ...
              contact any employee of the smapiot GmbH.
            </p>{" "}
            <p class={styles.paragraph}>
            ...
            <li class={styles.enumeration}>Authentication via GitHub</li>
            <p class={styles.paragraph}>
              We are utilizing the GitHub login (88 Colin P Kelly Junior St, San
              Francisco, California, 94107, United States) for authenticating
              the data subject to ensure that the same data subject is not able
              to complete the survey more than once. In this context, the
              GitHub account name is stored as an unique identifier for the data
              subject.
            </p>
            <p class={styles.paragraph}>
              The applicable data protection provisions of GitHub may be
              retrieved under{" "}
              <a
            ...
            <li class={styles.enumeration}>Collection and usage of data</li>
            <p class={styles.paragraph}>
              The survey responses of the data subject submitted as part of the
              survey will be stored together with the data subject's GitHub
              account name. The summarized results of the survey will be
              published in anonymized form without any traceability to the data
              subject. After the survey is closed and has been analyzed the
              stored account names will be anonymized.
            </p>{" "}
            <li class={styles.enumeration}>Legal basis for the processing</li>
            <p class={styles.paragraph}>
              ...
              operations which are not covered by any of the above mentioned
            ...
            <li class={styles.enumeration}>Updates and notifications</li>
            <p class={styles.paragraph}>
              We may amend this policy from time to time to reflect changes to
              our privacy practices or relevant legislation. Any changes will
              take effect at the time we publish the revised policy or otherwise
              provide notice of the update as required by law.
            </p>{" "}
            <p class={styles.paragraph}>
              Largely developed by the specialists for{" "}
              <a href="https://willing-able.com/" target="_blank">
                LegalTech
              </a>{" "}
              at Willing & Able that also developed the system for{" "}
              <a href="https://abletorecords.com/" target="_blank">
                dpia gdpr
              </a>
              . The legal texts contained in our privacy policy generator have
              been provided and published by{" "}
              <a href="https://dg-datenschutz.de/" target="_blank">
